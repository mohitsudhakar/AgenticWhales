...
class TestDeferredReflection:
    ...
    def test_fetch_returns_valid_ticker(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            raw, alpha, days = AgenticWhalesGraph._fetch_returns(mock_graph, "NVDA", "2026-01-05")
    ...
    def test_fetch_returns_too_recent(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            raw, alpha, days = AgenticWhalesGraph._fetch_returns(mock_graph, "NVDA", "2026-04-19")
    ...
    def test_fetch_returns_delisted(self):
        ...
        with patch("yfinance.Ticker") as mock_ticker_cls:
            ...
            mock_ticker_cls.return_value = m
            raw, alpha, days = AgenticWhalesGraph._fetch_returns(mock_graph, "XXXXXFAKE", "2026-01-10")
        assert raw is None and alpha is None and days is None
    ...
    # AgenticWhalesGraph._resolve_pending_entries
    ...
    def test_resolve_skips_other_tickers(self, tmp_path):
        ...
        AgenticWhalesGraph._resolve_pending_entries(mock_graph, "NVDA")
...
class TestLegacyRemoval:
    ...
    def test_financial_situation_memory_removed(self):
        ...
        import agenticwhales.agents.utils.memory as m
    ...
    def test_reflect_and_remember_removed(self):
        """AgenticWhalesGraph must not expose reflect_and_remember."""
        assert not hasattr(AgenticWhalesGraph, "reflect_and_remember")
    ...
    def test_full_pipeline_no_regression(self, tmp_path):
        ...
        mock_graph._run_graph = functools.partial(
            AgenticWhalesGraph._run_graph, mock_graph
        )
        AgenticWhalesGraph.propagate(mock_graph, "NVDA", "2026-01-10")
